...
取数 / 规则打分 / 大模型分别对应哪条命令，见仓库根目录 `PIPELINE.md`。
...
- 2026-09-18 降低主题集中度：`simulations/2026-09-18-1407-theme-concentration-reduction.md`
- 同一记录的机器可读账本：`simulations/2026-09-18-1407-theme-concentration-reduction.json`
