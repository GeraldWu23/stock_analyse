...
from portfolio.engine.investor_db import by_id

import os
from typing import Any

from portfolio.engine.investor_criteria import INVESTOR_RULES, Rule
from portfolio.engine.investor_knowledge import reality_check
from portfolio.engine.investor_profile import get_profile as _get_profile
from portfolio.engine.investor_db import INVESTORS as _INVESTORS
...
def _is_youzi_out_of_range(investor_id: str, features: dict) -> tuple[bool, str]:
    ...
    if _INVESTOR_GROUP_MAP.get(investor_id) != "F":
        return False, ""
    try:
        from portfolio.engine.seat_db import SEATS, is_in_range
    except Exception:
        return False, ""
